...
запишите их в новый текстовой файл conf.txt. (рис. @fig:004). 

![ч. 2](image/2.PNG){#fig:004 width=70%}


3. Определите, какие файлы в вашем домашнем каталоге имеют имена, начинавшиеся
с символа c?  (рис. @fig:006). 

![ч. 3](image/3.PNG){#fig:006 width=70%}  
...
![ч. 4](image/4.PNG){#fig:009 width=70%} 

![ч. 5](image/5.PNG){#fig:010 width=70%} 
...
![ч. 6](image/5.PNG){#fig:011 width=70%} 

7. Выполните команды df и du, предварительно получив более подробную информацию
об этих командах, с помощью команды man. (рис. @fig:015).

![ч. 7](image/6.PNG){#fig:015 width=70%} 


8. Воспользовавшись справкой команды find, выведите имена всех директорий, имею-
щихся в вашем домашнем каталоге. рис. @fig:019). 

![ч. 8](image/7.PNG){#fig:019 width=70%} 

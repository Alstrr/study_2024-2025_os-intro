...
3. Создайте текстовой файл text.txt. Откройте этот файл с помощью встроенного в mc редактора. (рис. @fig:001).
...
текст. Сохраните и закройте файл. (рис. @fig:002). 
...
или выключите, если она включена. (рис. @fig:003). 

...
## 3. Создайте текстовой файл text.txt. Откройте этот файл с помощью встроенного в mc редактора. (рис. 1).
...
текст. Сохраните и закройте файл. (рис. 2). 
...
или выключите, если она включена. (рис. 3). 
